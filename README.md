...
<pre>git clone https://github.com/Nexus-Lua/Root.git</pre>
<pre>cd root</pre>
...
<pre>apt-get update && apt upgrade-y && apt-get install git -y && git clone https://github.com/Nexus-Lua/Root.git</pre>
